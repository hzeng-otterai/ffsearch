...
# download spell check data from SymSpell github and only keep the first column
curl -s https://raw.githubusercontent.com/wolfgarbe/SymSpell/master/SymSpell.Benchmark/test_data/frequency_dictionary_en_500_000.txt | cut -d " " -f 1 > frequency_dictionary_en_500_000.txt
